...
**Last verified:** 2026-04-05 | **App version:** macOS (App Store) | **Total documents:** ~55,953 across ~35 unique collection patterns (2026-04-05); a 2026-09-18 re-scan counted 62,790 documents (pattern count not re-derived). Note that "patterns" collapse per-entity subcollections — that 2026-09-18 scan expanded to 191 distinct collection *paths*
